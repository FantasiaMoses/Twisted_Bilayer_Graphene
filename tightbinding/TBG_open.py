...
# 修正点：由于交错势打开了能隙，不能再找单个距离0最近的值。
# 取中心两条带的平均值作为真正的 CNP (电荷中性点)。
mid_idx = dim // 2
...
# 4. 坐标轴与标题
plt.title(f"TBG Full Moire Bands at $\\theta = {theta}^\circ valley={valley}$ ($-300 \sim 300$ meV C2B)", fontsize=18)
